  ...
  return (
    <div className="bg-[#0B2D58] relative w-full overflow-hidden">
      <img
        src="/gear-icon.png"
        alt="Gear Right"
        className="hidden lg:block absolute top-[-26] right-12 opacity-70 z-0 pointer-events-none"
        style={{ width: '100px', height: '100px', transform: 'translateX(75%)' }}
      />
      <img
        src="/gear-icon.png"
        alt="Gear Left"
        className="hidden lg:block absolute top-76 left-2 opacity-70 z-0 pointer-events-none"
        style={{ width: '100px', height: '100px', transform: 'translateX(-25%)' }}
      />

      <img
        src="/gear-icon.png"
        alt="Gear Right Tablet"
        className="hidden md:block lg:hidden absolute top-[-24] right-9 opacity-70 z-0 pointer-events-none"
        style={{ width: '78.5px', height: '78.5px', transform: 'translateX(75%)' }}
      />
      <img
        src="/gear-icon.png"
      ...
      <img
        ...
        className="block md:hidden absolute top-[-12] right-6 opacity-80 z-0 pointer-events-none"
        style={{ width: '55.5px', height: '55.5px', transform: 'translateX(75%)' }}
      />
      <img
        src="/gear-icon.png"
        alt="Gear Left Mobile"
        className="block md:hidden absolute top-88 left-1.5 opacity-80 z-0 pointer-events-none"
        style={{ width: '55.5px', height: '55.5px', transform: 'translateX(-25%)' }}
      />
        ...
        <div className="relative px-4 sm:px-6 py-12">
          ...
          <div className="bg-white rounded-[28px] px-4 py-4 w-full mx-auto overflow-hidden relative z-20">
            <div className="flex flex-wrap justify-center items-start gap-6 md:flex-row md:items-center lg:flex-row lg:items-center lg:flex-nowrap">
              {[
                { title: "Real Time", text: "See where borrowers are applying" },
                { title: "48 Hrs", text: "Is the professional borrowers' window before detection" },
              ...
              >
                <div className="absolute top-4 right-4">
                  <img src="/rocket2.svg" alt="Rocket Icon" className="w-6 h-6 text-white" />
                </div>
                ...
                <ul className="space-y-2 text-left text-[14px]">
                  ...
                  <li className="flex items-start gap-2">
                    <img src="/arrow-icon.svg" alt="Arrow Icon" className="w-4 h-4 mt-1" />
                    <span className="text-white leading-snug">Lifetime founding members pricing</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <img src="/arrow-icon.svg" alt="Arrow Icon" className="w-4 h-4 mt-1" />
                    <span className="text-white leading-snug">Direct input on product Development</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <img src="/arrow-icon.svg" alt="Arrow Icon" className="w-4 h-4 mt-1" />
                    <span className="text-white leading-snug">Recognition as an industry pioneer</span>
                  </li>
                </ul>
              </div>
            </div>
