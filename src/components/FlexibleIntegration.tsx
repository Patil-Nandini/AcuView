...
export default function FlexibleIntegrationOptions() {
  return (
    <>
      ...
      `}</style>
      <section
        className="w-[100%] flex items-center justify-center bg-gradient-to-b from-[#c2e8ff]/50 to-[#FFFFFF] laptop-bg-image relative overflow-hidden pt-4 md:pt-0"
      >
        ...
        <div className="w-[95%] flex flex-col laptop-flex-row items-center laptop-justify-between justify-center px-4 py-6 md:py-6 laptop-py-24 gap-10 relative z-10">
          ...
          <div className="w-full laptop-basis-75 flex flex-col gap-8">
            ...
            >
              ...
              <div className="flex flex-col sm:grid sm:grid-cols-2 md:grid md:grid-cols-4 laptop-grid-cols-4 gap-6 laptop-gap-8 items-stretch">
