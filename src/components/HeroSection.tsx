...
const HeroSection: React.FC = () => {
  return (
    <section className="relative bg-white px-4 sm:px-8 lg:px-0 xl:px-12 py-12 lg:py-20 font-sarabun mt-10">
      <div className="w-[90%] mx-auto flex flex-col lg:flex-row gap-4 sm:gap-[10] items-center lg:w-[100%]">
        <div className="md:w-[50%]">
          ...
          <div
            className=" hidden md:block relative bg-cover bg-no-repeat bg-center rounded-2xl lg:h-[370px] xl:h-[414px] lg:w-[492px] xl:w-[609px] md:w-[676px] md:h-[428px] mt-5 md:bg-[url('/tabview-bg-acuview.webp')] bg-[url('/LeftsideContentBg.png')]"
            // style={{ backgroundImage: "url('/LeftsideContentBg.png')" }}
          >
            <div className="absolute inset-0 flex md:w-[676px] md:h-[428px] lg:w-[492px] lg:h-[370px] xl:w-[589px] ">
              <div className="flex flex-col justify-between h-full pl-8 pt-8 pb-8 w-[45%]">
                <div>
                  ...
                  <p className="text-[16px] md:text-[17px] text-[#333] mt-2 font-normal">
                ...
                <div>
                  <Image
                    ...
                    width={120}
                    height={120}
                    className="lg:w-[200px] md:w-[250px] rounded-xl"
                    style={{ objectFit: "cover" }}
                  />
                </div>
              </div>

              <div className="relative flex flex-col justify-between h-full w-[55%] pr-8 py-8 md:left-[27px]">
        ...
        <div className="flex flex-col items-start sm:items-center gap-6 w-[100%] sm:h-[770px] md:h-[748px] lg:h-[579px] lg:w-[50%]">
          <div className="relative w-[100%] h-[206px] sm:h-[770px] sm:w-[500px] md:w-[736px] xl:w-[600px] xl:h-[423px] lg:w-[517px] lg:h-[366px] rounded-2xl overflow-hidden">
            <video
              autoPlay
              loop
              muted
              playsInline
              className="absolute inset-0 w-full h-full object-contain sm:object-cover lg:w-[517px] lg:h-[366px] "
            >
