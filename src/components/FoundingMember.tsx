// // app/components/FoundingBenefits.tsx
// "use client";
...
//       <h2 className="text-[34px] sm:text-[36px] font-extrabold text-[#07102A] leading-tight flex items-center justify-center text-center">
...
//         <button
//           type="button"
//           className="flex items-center justify-center h-[90px] text-white font-semibold cursor-pointer w-[270px] sm:w-[270px] px-7 mt-5 ml-[-7px]"
//           style={{
...
//             height={20}
//           />
//           <span className="ml-2 whitespace-nowrap"> Join The Network Now!</span>
//         </button>
//       </div>
...
//         <div
//             className=" block md:hidden relative lg:mx-auto
//               w-[320px] max-w-[320px]
...
//           <div className="absolute bottom-[285px] left-[-28px] text-[16px] font-bold text-[#0F1720] text-center w-[200px]">
//             FOUNDING MEMBER BENEFITS
//           </div>
